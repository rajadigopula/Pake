...
(function() {
    ...
    function removeAds() {
        ...
        const allElements = document.querySelectorAll('ytd-rich-item-renderer, ytd-compact-video-renderer');
        allElements.forEach(el => {
            const adBadge = el.querySelector('.ytd-ad-slot-renderer, ytd-ad-slot-renderer');
            if (adBadge) {
                el.remove();
    ...
    function interceptConfig() {
        ...
        JSON.parse = function(...args) {
            ...
            if (result && typeof result === 'object') {
                ...
                const adKeys = [
                    'playerAds', 'adPlacements', 'adSlots', 'playerResponse',
                    'adBreakParams', 'adSafetyReason', 'adsToken'
                ];
